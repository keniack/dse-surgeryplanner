...
public class StatusMasterdataHystrixCommand extends GenericHystrixCommand {

    public StatusMasterdataHystrixCommand(String group, String askKey) {
        super(group, askKey);
        setUrl(PropertiesUtil.getValue("masterdata.url.status"));
    }
