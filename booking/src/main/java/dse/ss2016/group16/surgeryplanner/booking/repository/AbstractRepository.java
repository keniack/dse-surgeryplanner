...
/**
 *Created by Cynthia Marcelino (cynthia.marcelino@student.tuwien.ac.at) on 12:41:50 AM
 *
 */
public abstract class AbstractRepository<T> {
    ...
    T getEntityFromDBObject(DBObject object) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
