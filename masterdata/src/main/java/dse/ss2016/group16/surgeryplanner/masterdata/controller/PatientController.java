...
public class PatientController {
		...
		Patient create(@RequestBody @Valid Patient entry) {
	        return service.create(entry);
	    }
	 
	    @RequestMapping(value = "{id}", method = RequestMethod.DELETE)
	    Patient delete(@PathVariable("id") String id) throws EntryNotFoundException {
	    ...
	    Patient findById(@PathVariable("id") String id) throws EntryNotFoundException {
	        return service.findById(id);
	    }
	 
	    @RequestMapping(value = "{id}", method = RequestMethod.PUT)
	    Patient update(@RequestBody @Valid Patient entry) throws EntryNotFoundException {
